        ...
        <main className='bg-yellow-50 dark:bg-gray-900 text-gray-900 dark:text-white p-10 px-30 md:px-40 lg:px-80'>
            ...
            <div className='flex '>
                <div className='text-justify'>
                    ...
                    <p className='py-3'>I am a dedicated student pursuing Full Stack Development at Business College Helsinki, with a passion for technology 
                    ...
                    <p className='py-3'>My journey into the world of programming began just over a year ago. Since then, I have been on an exciting path of 
                    ...
                    <p className='py-3'>I've had the privilege of learning from incredible teachers and collaborating with supportive friends who have played a 
                    ...
                    <p className='py-3'>I bring a solid foundation in full stack development, coupled with a proactive attitude and a strong desire to learn and grow 
                    ...
                    <p className='py-3'>Before becoming developer, i worked in cleaning and property maintenance sector. I gained my soft skills like working in groups, 
                    ...
                    <p className='py-3'>Thank you for taking the time to learn more about me and my journey in Full Stack Development. I'm always open to new opportunities,
                    ...
                    <p className='py-3'>Let's connect !😊</p>
