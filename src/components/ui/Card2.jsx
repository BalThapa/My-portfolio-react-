...
const Card2 = ({ video, title, subtitle, link1, link2}) => {
  return (
    <div className="flex bg-yellow-100  flex-col dark:bg-gray-800 md:flex-col lg:flex-row h-auto p-5 lg:h-auto items-center justify-start shadow-md shadow-gray-500 dark:shadow-gray-100 rounded-xl duration-300 ease-in-out hover:scale-110 ">
