...
const Card1 = ({image, title, subtitle, link, linkName, width}) => {
    ...
    return (
        <section className='dark:bg-gray-800 bg-yellow-100 w-80 h-100 flex flex-col items-center justify-center p-5 text-center shadow-md shadow-gray-500 dark:shadow-gray-100 rounded-xl duration-300 ease-in-out hover:scale-110'>
